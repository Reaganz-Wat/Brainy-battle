...
const S = () => {
    ...
    const getQuestionsFromDatabase = () => {
        axios.get(`http://10.160.1.151/WEB APPLICATIONS/brainybattle/CONTROLLERS/get_questions.php?level_id=${level_id}&subject_id=${subject_id}`)
        .then(response=>{
    ...
    useEffect(()=>{getQuestionsFromDatabase()}, []);
